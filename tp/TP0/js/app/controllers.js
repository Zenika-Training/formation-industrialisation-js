...
zenContactApp.controller('LoginController', ['$scope', '$http', 'authService', 
...
zenContactApp.controller('ContactListController', ['$scope', 'Contact', 
...
zenContactApp.controller('ContactEditController', [
    '$scope', '$http', '$routeParams', '$location', 'Contact', 'authService', 
    function ($scope, $http, $routeParams, $location, Contact, authService) {
        if ($routeParams.id) {
