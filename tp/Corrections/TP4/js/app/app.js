...
var zenContactApp = angular.module('zenContactApp', [
    'zenContactServices', 'zenContactFilters', 'zenContactDirectives', 
    'ngRoute', 'ngCookies']);

zenContactApp.config(['$routeProvider', '$httpProvider', 
...
zenContactApp.run(['$rootScope', '$location', 'authService', 
